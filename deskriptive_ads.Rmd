...
author: "Jan Kirenz, Hochschule der Medien"
subtitle: Deskriptive Statistik
output:
  html_document:
    df_print: paged
---
In diesem Anwendungsbeispiel werden unterschiedliche Visualisierungen und Kennzahlen vorgstellt. 
...
Wir betrachten nun einige Kennzahlen am Beispiel der Variable *sales*. 
...
ggplot(Advertising, aes(sales)) +
  geom_histogram(binwidth = 2, color="Steelblue", alpha=.2) +
